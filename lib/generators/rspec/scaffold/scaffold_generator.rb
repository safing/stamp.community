# copied from https://github.com/rspec/rspec-rails/blob/master/lib/generators/rspec/scaffold/scaffold_generator.rb
# replaced controller with request specs
# adjusted lines: 21, 31-40
    ...
    class ScaffoldGenerator < Base
      ...
      def generate_request_spec
        ...
        template_file = File.join(
          ...
          "#{singular_table_name}_requests_spec.rb"
        )
